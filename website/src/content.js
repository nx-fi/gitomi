...
function renderHeroBoard() {
  return `
    <div class="browser-shot parallax-layer" data-parallax data-depth="16">
...
<body class="site-shell">
  ...
  <div class="corner-actions" aria-label="Site actions">
    <a class="github-link" href="https://github.com/nx-fi/gitomi" target="_blank" rel="noreferrer">GitHub</a>
  ...
  <main id="top" class="site-main">
    <section class="hero-section" aria-labelledby="hero-title">
      <div class="hero-copy">
        <a class="hero-brand" href="#top" aria-label="Gitomi home">
          <img src="./assets/logo.svg" alt="" width="47" height="32">
          <span>Gitomi</span>
        </a>
        <p class="pain-line">Open source, free forever.</p>
        <h1 id="hero-title">Own your <span class="hero-rotator" data-typewriter data-words="project|tasks|workflows|collaboration">project</span>, not just your code.</h1>
      ...
      <div class="hero-stage" aria-hidden="true">
        <div class="repo-card parallax-layer" data-parallax data-depth="-8">
          <span class="button-icon icon-branch" aria-hidden="true"></span>
          <strong>refs/gitomi/*</strong>
          <small>signed project history</small>
        </div>
        ${renderHeroBoard()}
        <div class="terminal-shot parallax-layer" data-parallax data-depth="22">
...
<span class="muted">sync</span> ordinary git transport ready</code></pre>
    ...
    <section id="how" class="proof-section">
      ...
      <div class="repo-visual parallax-layer" data-parallax data-depth="10" aria-label="Repository ref layout">
    ...
    <section class="sync-section">
      ...
      <div class="sync-map" aria-hidden="true">
        <div class="sync-terminal parallax-layer" data-parallax data-depth="8">
          <div class="terminal-head">
            <span></span>
...
<span class="muted">projection</span> issues + PRs + boards rebuilt</code></pre>
    ...
    <section class="offline-section">
      ...
      <div class="offline-lab" aria-hidden="true">
        <article class="device-panel parallax-layer" data-parallax data-depth="14">
        ...
        <article class="device-panel is-online parallax-layer" data-parallax data-depth="-10">
          <div class="device-head">
            <span></span>
    ...
    <section class="agent-section">
      ...
      <div class="agent-console parallax-layer" data-parallax data-depth="12" aria-hidden="true">
