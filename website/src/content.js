    ...
    <section class="hero-section" aria-labelledby="hero-title">
      ...
      <div class="hero-stage" aria-hidden="true">
        ...
        <div class="terminal-shot">
          ...
          <pre><code><span class="prompt" aria-hidden="true">$</span> <span data-typewriter data-words="gt issue open --title own-the-workflow|git fetch origin refs/gitomi/*|gt web --offline-ready">gt issue open --title own-the-workflow</span><span class="typing-caret"></span>
    ...
    <section class="sync-section">
      ...
      <div class="sync-map" aria-hidden="true">
        <div class="sync-terminal">
          ...
          <pre><code><span class="prompt" aria-hidden="true">$</span> git fetch origin 'refs/gitomi/*:refs/gitomi/staging/*'
<span class="ok">remote</span> 42 project events received
<span class="prompt" aria-hidden="true">$</span> gt sync --admit
