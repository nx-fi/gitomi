...
pub fn handleIssueBulkPost(allocator: Allocator, repo: Repo, stream: @import("compat").net.Stream, form_body: []const u8) !void {
    try index.ensureIndex(allocator, repo);
...
fn applyIssueBulkAction(allocator: Allocator, repo: Repo, stream: @import("compat").net.Stream, issue_id: []const u8, action: []const u8) !bool {
