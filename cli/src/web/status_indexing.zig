...
pub fn handleIndexRebuild(allocator: Allocator, repo: Repo, stream: std.net.Stream) !void {
    try index.ensureIndex(allocator, repo);
    try shared.sendResponse(allocator, stream, 204, "No Content", "text/plain", "", null);
}

pub fn handleNavStats(allocator: Allocator, repo: Repo, stream: std.net.Stream) !void {
