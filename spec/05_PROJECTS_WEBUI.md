...
| `pipeline` | Issue metadata | Where the issue is in the work pipeline, such as `Todo`, `Pending`, `In Review`, `Done`. |
...
| `pipeline` | scalar enum | `Todo`, `Pending`, `In Review`, `Done` | Default board axis. |
